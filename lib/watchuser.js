...
var removeEmptyFields = function removeEmptyFields(obj) {
  ...
  Object.keys(obj).forEach(function (propName) {
    if (obj[propName] !== null && obj[propName] !== undefined) newObj[propName] = obj[propName];
  });
  return newObj;
};
...
var supportPassive = exports.supportPassive = function supportPassive() {
...
var watchUser = function () {
  ...
  publicApi.getEvents = function () {
    return _store2.default.getEvents();
  };
...
function skipEvent(config, event) {
  ...
  var type = event.type;
  var mergeMouseEvents = config.mergeMouseEvents,
      disabledEvents = config.disabledEvents,
      disableMouseMove = config.disableMouseMove,
      deviceEvents = config.deviceEvents;


  if (mergeMouseEvents) {
    var isMouse = (0, _utils.startWith)(type, 'mouse');
    var isTouch = (0, _utils.startWith)(type, 'touch');
    if (_utils.pointerSupports && (isMouse || isTouch)) return true;
  }

  if (disableMouseMove) {
    var isMoveEvent = (0, _utils.endWith)(type, 'out') || (0, _utils.endWith)(type, 'over') || (0, _utils.endWith)(type, 'move');
    if (isMoveEvent) return true;
  }

  if (disabledEvents && disabledEvents.length && (0, _utils.includes)(disabledEvents, type)) return true;

  if (deviceEvents === false && (0, _utils.startWith)(type, 'device')) return true;
  return false;
}
...
var thirdParams = _utils.supportPassive ? { passive: true, capture: true } : true;
...
var _pointer = __webpack_require__(12);
...
var _readyState = __webpack_require__(16);
...
var _visibility = __webpack_require__(21);

var _visibility2 = _interopRequireDefault(_visibility);

var _screenOrientation = __webpack_require__(22);
...
exports.default = function (event) {
  event.toString = _element2.default;

  if ((0, _utils.startWith)(event.type, 'pageshow')) event.toString = _empty2.default;
  if ((0, _utils.startWith)(event.type, 'mouse')) event.toString = _mouse2.default;
  if ((0, _utils.startWith)(event.type, 'touch')) event.toString = _touch2.default;
  if ((0, _utils.startWith)(event.type, 'pointer')) event.toString = _pointer2.default;
  if ((0, _utils.startWith)(event.type, 'key')) event.toString = _keyboard2.default;
  if ((0, _utils.startWith)(event.type, 'click')) event.toString = _click2.default;
  if ((0, _utils.startWith)(event.type, 'scroll')) event.toString = _scroll2.default;
  if ((0, _utils.startWith)(event.type, 'resize')) event.toString = _resize2.default;
  if ((0, _utils.startWith)(event.type, 'copy')) event.toString = _clipboard2.default;
  if ((0, _utils.startWith)(event.type, 'cut')) event.toString = _clipboard2.default;
  if ((0, _utils.startWith)(event.type, 'paste')) event.toString = _clipboard2.default;
  if ((0, _utils.startWith)(event.type, 'wheel')) event.toString = _wheel2.default;
  if ((0, _utils.startWith)(event.type, 'readystate')) event.toString = _readyState2.default;
  if ((0, _utils.startWith)(event.type, 'visibility')) event.toString = _visibility2.default;
  if ((0, _utils.startWith)(event.type, 'selectionchange')) event.toString = _selection2.default;
  if ((0, _utils.includes)(event.type, 'orientationchange')) event.toString = _screenOrientation2.default;
...
exports.default = function () {
  var x = this.screenX;
  var y = this.screenX;
  var info = { x: x, y: y, element: (0, _helpers.stringElement)(this) };
...
exports.default = function () {
  ...
  var x = element.scrollLeft || null;
  var y = element.scrollTop || null;
...
exports.default = function () {
  var text = document.getSelection ? document.getSelection().toString() : '???';
...
exports.default = function () {
  var info = { state: document.visibilityState };
  return this.type + ' ' + (0, _helpers.clearString)(info);
};
...
exports.default = function () {
  ...
  var info = { type: orientation.type, angle: orientation.angle };
  return this.type + ' ' + (0, _helpers.clearString)(info);
};
